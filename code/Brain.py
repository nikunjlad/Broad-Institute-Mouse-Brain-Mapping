...
class Brain:
    ...
    def main(self):
        ...
        train_data = np.load(os.path.sep.join([self.model_path, "train_data.npy"]))
        valid_data = np.load(os.path.sep.join([self.model_path, "valid_data.npy"]))
        test_data = np.load(os.path.sep.join([self.model_path, "test_data.npy"]))
        train_labels = np.load(os.path.sep.join([self.model_path, "train_labels.npy"]))
        valid_labels = np.load(os.path.sep.join([self.model_path, "valid_labels.npy"]))
        test_labels = np.load(os.path.sep.join([self.model_path, "test_labels.npy"]))
