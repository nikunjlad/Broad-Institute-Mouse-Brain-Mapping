...
class Processing:
    ...
    def adaptive_histogram(self, image, clipLimit, tile_grid):
        """
    ...
    def adaptive_gaussian_thresholding(self, image, blur_factor, maxValue, blockSize, const):
        """
        ...
        try:
            if isinstance(image, list):
                ...
                for img in image:
                    ...
                    thresholded = cv2.adaptiveThreshold(blur_cl1, maxValue=maxValue,
                                                        adaptiveMethod=cv2.ADAPTIVE_THRESH_GAUSSIAN_C,
                                                        thresholdType=cv2.THRESH_BINARY_INV, blockSize=blockSize,
                                                        C=const)
